...
QT_MOC_LITERAL(1, 16, 22), // "signalClickedSomething"
QT_MOC_LITERAL(2, 39, 0) // ""

    },
    "MyGraphicsScene\0signalClickedSomething\0"
    ""
};
...
void MyGraphicsScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalClickedSomething((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (MyGraphicsScene::*_t)(QPointF );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGraphicsScene::signalClickedSomething)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGraphicsScene::signalClickedSomething(QPointF _t1)
{
